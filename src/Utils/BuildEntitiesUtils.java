...
public class BuildEntitiesUtils {
    ...
    private TimeZoneEntity buildTimeZoneEntity(long gameCreationTimeStamp) {
        ...
        currentTimeZoneEntity.etcGmtPlus12 = instant.atZone(ZoneId.of("Etc/GMT+12"));
        currentTimeZoneEntity.pacificPagoPago = instant.atZone(ZoneId.of("Pacific/Pago_Pago"));
        currentTimeZoneEntity.pacificHonolulu= instant.atZone(ZoneId.of("Pacific/Honolulu"));
        currentTimeZoneEntity.americaAnchorage = instant.atZone(ZoneId.of("America/Anchorage"));
        currentTimeZoneEntity.americaLosAngeles = instant.atZone(ZoneId.of("America/Los_Angeles"));
        currentTimeZoneEntity.americaDenver = instant.atZone(ZoneId.of("America/Denver"));
        currentTimeZoneEntity.americaChicago = instant.atZone(ZoneId.of("America/Chicago"));
        currentTimeZoneEntity.americaNewYork = instant.atZone(ZoneId.of("America/New_York"));
        currentTimeZoneEntity.americaHalifax = instant.atZone(ZoneId.of("America/Halifax"));
        currentTimeZoneEntity.americaStJohns = instant.atZone(ZoneId.of("America/St_Johns"));
        currentTimeZoneEntity.americaBuenosAires = instant.atZone(ZoneId.of("America/Argentina/Buenos_Aires"));
        currentTimeZoneEntity.atlanticSouthGeorgia = instant.atZone(ZoneId.of("Atlantic/South_Georgia"));
        currentTimeZoneEntity.atlanticAzores = instant.atZone(ZoneId.of("Atlantic/Azores"));
        currentTimeZoneEntity.europeLondon = instant.atZone(ZoneId.of("Europe/London"));
        currentTimeZoneEntity.europeParis = instant.atZone(ZoneId.of("Europe/Paris"));
        currentTimeZoneEntity.africaCairo = instant.atZone(ZoneId.of("Africa/Cairo"));
        currentTimeZoneEntity.europeMoscow = instant.atZone(ZoneId.of("Europe/Moscow"));
        currentTimeZoneEntity.asiaTehran = instant.atZone(ZoneId.of("Asia/Tehran"));
        currentTimeZoneEntity.asiaDubai = instant.atZone(ZoneId.of("Asia/Dubai"));
        currentTimeZoneEntity.asiaKabul = instant.atZone(ZoneId.of("Asia/Kabul"));
        currentTimeZoneEntity.asiaKarachi = instant.atZone(ZoneId.of("Asia/Karachi"));
        currentTimeZoneEntity.asiaKolkata = instant.atZone(ZoneId.of("Asia/Kolkata"));
        currentTimeZoneEntity.asiaKathmandu = instant.atZone(ZoneId.of("Asia/Kathmandu"));
        currentTimeZoneEntity.asiaDhaka = instant.atZone(ZoneId.of("Asia/Dhaka"));
        currentTimeZoneEntity.asiaYangon = instant.atZone(ZoneId.of("Asia/Yangon"));
        currentTimeZoneEntity.asiaBangkok = instant.atZone(ZoneId.of("Asia/Bangkok"));
        currentTimeZoneEntity.asiaShanghai = instant.atZone(ZoneId.of("Asia/Shanghai"));
        currentTimeZoneEntity.asiaTokyo = instant.atZone(ZoneId.of("Asia/Tokyo"));
        currentTimeZoneEntity.australiaAdelaide = instant.atZone(ZoneId.of("Australia/Adelaide"));
        currentTimeZoneEntity.australiaSydney = instant.atZone(ZoneId.of("Australia/Sydney"));
        currentTimeZoneEntity.australiaLordHowe = instant.atZone(ZoneId.of("Australia/Lord_Howe"));
        currentTimeZoneEntity.pacificNoumea = instant.atZone(ZoneId.of("Pacific/Noumea"));
        currentTimeZoneEntity.pacificAuckland = instant.atZone(ZoneId.of("Pacific/Auckland"));
        currentTimeZoneEntity.pacificChatham = instant.atZone(ZoneId.of("Pacific/Chatham"));
        currentTimeZoneEntity.pacificTongatapu = instant.atZone(ZoneId.of("Pacific/Tongatapu"));
        currentTimeZoneEntity.pacificKiritimati = instant.atZone(ZoneId.of("Pacific/Kiritimati"));
